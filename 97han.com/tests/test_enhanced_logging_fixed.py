...
class TestEnhancedLogger(unittest.TestCase):
    ...
    def test_initialization(self):
        ...
        self.assertEqual(self.logger.buffer_size, 10)
        self.assertIsNotNone(self.logger.buffer)
...
class TestDataValidator(unittest.TestCase):
    ...
    def test_validate_movie_data_invalid(self):
        ...
        self.assertIn("缺少必填字段", error_msg)
    ...
    def test_check_duplicate_id(self):
        """测试重复ID检查"""
        # 第一次添加ID
        is_duplicate = self.validator.check_duplicate_id(12345)
    ...
    def test_get_validation_summary(self):
        ...
        self.validator.validation_stats['duplicate_checks'] = 2
        
        summary = self.validator.get_validation_summary()
        
        self.assertEqual(summary['total_checks'], 10)
        self.assertEqual(summary['duplicate_checks'], 2)
